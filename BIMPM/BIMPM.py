...
class BIMPM(nn.Module):
    ...
    def __init__(self, args, data):
        ...
        self.context_LSTM = nn.LSTM(
                ...
                num_layers = 1,
                bidirectional = True,
                batch_first = True) # Use bidirectional LSTM to train context_LSTM
        ...
        self.aggregation_LSTM = nn.LSTM(
                ...
                num_layers = 1,
                bidirectional = True,
                batch_first = True) # Use bidirectional LSTM to train aggregation layer
    ...
    def reset_parameters(self):
        ...
        nn.init.constant_(self.context_LSTM.weight_ih_l0, val=0)
    ...
    def forward(self, **kwargs):
        ...
        mv_p_full_bw = mp_matching_func(con_p_bw, con_h_fw[:, 0, :], self.mp_w2)
        ...
        # (batch, seq_len2, hidden_size) -> (batch, l, seq_len2, hidden_size)
        # (batch, seq_len1, seq_len2) -> (batch, seq_len1, seq_len2, l)
        # -> (batch, seq_le1, seq_len2, hidden_size)
